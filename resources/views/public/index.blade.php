  ...
  <div class="bg-gray-100">
    @include("public.hader")
      ...
      <section class="mt-10 w-full">
        <h1 class="text-4xl font-bold text-center text-blue-500 font-outtfit">
          ¿Por qué viajar con nosotros?
        </h1>
        <div class="mt-10 px-16 flex items-center gap-10">
          <div class="">
            <div class="flex justify-center">
              <i class="fa-solid fa-shield  text-8xl mx-auto text-blue-500"></i>
            </div>
          ...
          <div class="">
            <div class="flex justify-center">
              <i class="fa-solid fa-money-bill text-8xl mx-auto text-blue-500"></i>
            </div>
            <h2 class="text-xl font-outtfit font-bold text-blue-500 text-center mt-5">
              Precios Accesibles
            </h2>
