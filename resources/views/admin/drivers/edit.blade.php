    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900">
          <form action="{{route("drivers.update", $driver)}}" method="post" class="mt-6 space-y-6">
            @csrf
            <div>
            ...
            <div class="flex gap-10 w-full items-center">
              ...
              <div class="w-1/2">
                <button 
                  type="submit" 
                  class="p-3 text-blue-500 rounded-lg hover:bg-blue-800 hover:text-white transition border-2 border-solid border-blue-500 cursor-hover flex gap-3 items-center w-32 mb-3 mt-5"
                >
                  <i class="fa-solid fa-rotate-left"></i>
                  Guardar
                </button>
